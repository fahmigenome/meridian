      ...
      if (name === "swap_token" && result.tx) {
        ...
        try {
          ...
          const pmData = buildPostMortemData(args.position_address, result, {
            ...
            fees_earned_usd: result.fees_earned_usd ?? tracked?.total_fees_claimed_usd ?? 0,
            initial_value_usd: result.initial_value_usd ?? tracked?.initial_value_usd ?? 0,
            final_value_usd: result.final_value_usd ?? 0,
